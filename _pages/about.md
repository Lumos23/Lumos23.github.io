...
Hi! I'm Luxi He (feel free to call me Lucy). I'm a third-year CS Ph.D. student at Princeton University, where I'm fortunate to be co-advised by [Prof. Danqi Chen](https://www.cs.princeton.edu/~danqic/) and [Prof. Peter Henderson](https://www.peterhenderson.co/). My current research focuses on understanding language models and improving their **alignment and safety**. Recently, I am particularly interested in building **better human-LLM alignment and human-agent collaboration** from first principles. I'm also interested in the **impact of data** in the language model life cycle, such as understanding and predicting data's impact on training and model reliability. Motivated by real-world impact and my hope to bridge the gap between tech and policy, I want to bring in insights from both technical and policy sides to my research. 
